...
model = GraphCPPModule.load_from_checkpoint(checkpoint_path="model/checkpoints/epoch=22-step=69.ckpt", map_location=None if AVAIL_GPUS>0 else torch.device('cpu'))
model.eval()
model.freeze()
